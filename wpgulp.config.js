...
module.exports = {
	...
	// Project options.
	projectURL: 'wpcnl.local', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	productURL: './', // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.
	browserAutoOpen: false,
	injectChanges: true,

	// Style options.
	styleSRC: './css/style.scss', // Path to main .scss file.
	...
	// JS Vendor options.
	jsVendorSRC: './vendor/*.js', // Path to JS vendor folder.
	jsVendorDestination: './js/', // Path to place the compiled JS vendors file.
	jsVendorFile: 'vendor', // Compiled JS vendors file name. Default set to vendors i.e. vendors.js.

	// JS Custom options.
	jsCustomSRC: './js/*.js', // Path to JS custom scripts folder.
	...
	// Translation options.
	textDomain: 'wp-custom-ninja-logic', // Your textdomain here.
	translationFile: 'wp-custom-ninja-logic.pot', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'WP_Custom_Ninja_Logic', // Package name.
	bugReport: 'https://example.com/contact/', // Where can users report bugs.
	lastTranslator: 'Jude Rosario <your_email@email.com>', // Last translator Email ID.
	team: 'Codeable <your_email@email.com>', // Team's Email ID.
